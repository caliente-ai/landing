  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="animate-rise-in mt-7 font-display font-bold tracking-[-0.03em] text-balance leading-[0.98] text-bone text-[clamp(3rem,9vw,6rem)] [animation-delay:80ms]">
          {site.product}
        </h1>
...
function HeroBackdrop() {
  return (
    ...
    >
      ...
      {/* Warm ember light source */}
      <div className="absolute left-1/2 top-[-240px] h-[480px] w-[860px] max-w-[150vw] -translate-x-1/2 rounded-[50%] bg-ember/20 blur-[140px]" />
