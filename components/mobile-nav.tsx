...
/** Hamburger menu shown only below the `md` breakpoint. The desktop nav in
 *  SiteHeader is untouched. */
export function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      <div
        inert={!open}
        className={`fixed inset-x-0 bottom-0 top-16 z-40 overflow-y-auto bg-ink transition-opacity duration-200 ${
